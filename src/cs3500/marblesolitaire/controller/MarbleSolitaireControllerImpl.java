...
public class MarbleSolitaireControllerImpl implements MarbleSolitaireController {
  ...
  /**
   * Constructor taking Readable and Appendable objects to handle input and output.
   *
   * @param rd To handle inputs coming from the user.
   * @param ap To handle outputs to be sent to the user.
